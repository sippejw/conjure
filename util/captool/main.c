...
void sigproc_child(int sig)
{
    ...
    fprintf(stderr, "PF_RING zero-copy Captool child process shut down\n");
    exit(0);
}
...
void sigproc_parent(int sig)
{
    ...
    fprintf(stderr, "PF_RING Captool shutting down...\n");
    ...
    fprintf(stderr, "PF_RING Captool done shutting down!\n");
    exit(0);
}
